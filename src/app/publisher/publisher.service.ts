...
getAuthorById(id: number) {
  ...
  saveBooks(data: { name: string }): Observable<any> {
    return this.http.post(`${this.apiUrl}/api/publisher/books/create/`, data);
  }
...
getCountForPublisher():Observable<any> {
  return this.http.get<any>(`${this.apiUrl}/api/PublisherStats/`);
}
